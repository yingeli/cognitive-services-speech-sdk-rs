...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _azac_empty"][::std::mem::size_of::<_azac_empty>() - 0usize];
    ["Alignment of _azac_empty"][::std::mem::align_of::<_azac_empty>() - 1usize];
};
...
pub const PropertyId_Speech_StartEventSensitivity: PropertyId = 9010;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AudioProcessingOptions_MicrophoneCoordinates"]
        [::std::mem::size_of::<AudioProcessingOptions_MicrophoneCoordinates>() - 12usize];
    ["Alignment of AudioProcessingOptions_MicrophoneCoordinates"]
        [::std::mem::align_of::<AudioProcessingOptions_MicrophoneCoordinates>() - 1usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneCoordinates::X"]
        [::std::mem::offset_of!(AudioProcessingOptions_MicrophoneCoordinates, X) - 0usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneCoordinates::Y"]
        [::std::mem::offset_of!(AudioProcessingOptions_MicrophoneCoordinates, Y) - 4usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneCoordinates::Z"]
        [::std::mem::offset_of!(AudioProcessingOptions_MicrophoneCoordinates, Z) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AudioProcessingOptions_MicrophoneArrayGeometry"]
        [::std::mem::size_of::<AudioProcessingOptions_MicrophoneArrayGeometry>() - 18usize];
    ["Alignment of AudioProcessingOptions_MicrophoneArrayGeometry"]
        [::std::mem::align_of::<AudioProcessingOptions_MicrophoneArrayGeometry>() - 1usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneArrayGeometry::microphoneArrayType"][::std::mem::offset_of!(
        AudioProcessingOptions_MicrophoneArrayGeometry,
        microphoneArrayType
    )
        - 0usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneArrayGeometry::beamformingStartAngle"][::std::mem::offset_of!(
        AudioProcessingOptions_MicrophoneArrayGeometry,
        beamformingStartAngle
    )
        - 4usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneArrayGeometry::beamformingEndAngle"][::std::mem::offset_of!(
        AudioProcessingOptions_MicrophoneArrayGeometry,
        beamformingEndAngle
    )
        - 6usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneArrayGeometry::numberOfMicrophones"][::std::mem::offset_of!(
        AudioProcessingOptions_MicrophoneArrayGeometry,
        numberOfMicrophones
    )
        - 8usize];
    ["Offset of field: AudioProcessingOptions_MicrophoneArrayGeometry::microphoneCoordinates"][::std::mem::offset_of!(
        AudioProcessingOptions_MicrophoneArrayGeometry,
...
pub const CODECCREATEEXPORTNAME: &[u8; 13] = b"codec_create\0";
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of codec_c_interface"][::std::mem::size_of::<codec_c_interface>() - 48usize];
    ["Alignment of codec_c_interface"][::std::mem::align_of::<codec_c_interface>() - 8usize];
    ["Offset of field: codec_c_interface::init"]
        [::std::mem::offset_of!(codec_c_interface, init) - 0usize];
    ["Offset of field: codec_c_interface::get_format_type"]
        [::std::mem::offset_of!(codec_c_interface, get_format_type) - 8usize];
    ["Offset of field: codec_c_interface::encode"]
        [::std::mem::offset_of!(codec_c_interface, encode) - 16usize];
    ["Offset of field: codec_c_interface::flush"]
        [::std::mem::offset_of!(codec_c_interface, flush) - 24usize];
    ["Offset of field: codec_c_interface::endstream"]
        [::std::mem::offset_of!(codec_c_interface, endstream) - 32usize];
    ["Offset of field: codec_c_interface::destroy"]
        [::std::mem::offset_of!(codec_c_interface, destroy) - 40usize];
};
unsafe extern "C" {
